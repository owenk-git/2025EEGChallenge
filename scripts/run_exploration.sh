...
# Run all exploration experiments (Exp 1-10)
# This is the EXPLORE phase before EXPLOIT

set -e

GPU=${1:-0}  # Default GPU 0, or specify: ./run_exploration.sh 1

echo "=========================================="
echo "🔬 EXPLORATION PHASE: Experiments 1-10"
echo "=========================================="
echo "GPU: $GPU"
echo "Started: $(date)"
echo ""
...
run_exp 1 1 50 50 0.2 1e-3 32 "C1 Baseline"
run_exp 2 2 50 50 0.2 1e-3 32 "C2 Baseline"
