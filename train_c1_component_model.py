#!/usr/bin/env python3
"""
Train Multi-Component RT Model
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train Multi-Component RT Model')
    ...
    # Create model
    print("Creating RT Component Model...")
    ...
    print(f"\n{'='*60}")
    print(f"Training Multi-Component RT Model")
    print(f"{'='*60}\n")
    ...
    for epoch in range(args.epochs):
        ...
        print(f"  Component Weights - Attention: {weights['attention']:.3f}, Decision: {weights['decision']:.3f}, Motor: {weights['motor']:.3f}")

        # Save best model
        if val_nrmse < best_val_nrmse:
            best_val_nrmse = val_nrmse
            checkpoint_path = checkpoint_dir / 'c1_component_model_best.pt'
            torch.save({
                'epoch': epoch,
    ...
    print(f"Final component weights: {weights}")
